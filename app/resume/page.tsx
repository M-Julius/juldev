...
const CertificateItem = ({ cert, index }: { cert: typeof certificates[0], index: number }) => {
  ...
  return (
    <motion.div 
      ...
      className={`border-b border-border py-2 ${index === certificates.length - 1 ? 'border-b-0' : ''}`}
    >
...
export default function Resume() {
  ...
  const certificatesInView = useInView(certificatesRef, { once: true, margin: "-100px" });
          ...
          <div className="space-y-12">
            ...
            >
              ...
              >
                ...
                }} variant="default">Download CV</Button>
              </motion.div>
            </motion.div>
            ...
            <div className="grid gap-12 md:grid-cols-2">
              ...
              <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {skills.languages.map((lang, index) => (
                          ...
                          >
                            <span className="bg-secondary px-3 py-1 rounded-full text-sm">{lang.language}</span>
                ...
                >
                  <motion.h2 
                    initial={{ opacity: 0, x: 20 }}
                    animate={certificatesInView ? { opacity: 1, x: 0 } : { opacity: 0, x: 20 }}
                    transition={{ duration: 0.5 }}
                    className="text-2xl font-bold mb-6"
                  >
                    Certifications
